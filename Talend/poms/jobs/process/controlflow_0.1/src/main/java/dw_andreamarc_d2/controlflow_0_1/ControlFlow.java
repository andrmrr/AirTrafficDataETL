...
package dw_andreamarc_d2.controlflow_0_1;
 ...
 * @status
 */
public class ControlFlow implements TalendJob {
	...
	private final String jobName = "ControlFlow";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ControlFlow.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_DW_ANDREAMARC_D2_ControlFlow = new byte[0];
		static byte[] commonByteArray_DW_ANDREAMARC_D2_ControlFlow = new byte[0];

		public void readData(ObjectInputStream dis) {

			synchronized (commonByteArrayLock_DW_ANDREAMARC_D2_ControlFlow) {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				dw_andreamarc_d2.loadmonthtable_0_1.LoadMonthTable childJob_tRunJob_1 = new dw_andreamarc_d2.loadmonthtable_0_1.LoadMonthTable();
				// pass DataSources
				...
				for (String[] item_tRunJob_1 : childReturn_tRunJob_1) {
					...
					dw_andreamarc_d2.loaddimensiontables_0_1.LoadDimensionTables childJob_tRunJob_2 = new dw_andreamarc_d2.loaddimensiontables_0_1.LoadDimensionTables();
					// pass DataSources
					...
					dw_andreamarc_d2.loadfacttables_0_1.LoadFactTables childJob_tRunJob_3 = new dw_andreamarc_d2.loadfacttables_0_1.LoadFactTables();
					// pass DataSources
	...
	public static void main(String[] args) {
		final ControlFlow ControlFlowClass = new ControlFlow();

		int exitCode = ControlFlowClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ControlFlow.class.getClassLoader()
					.getResourceAsStream("dw_andreamarc_d2/controlflow_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ControlFlow.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ControlFlow");
		}
...
/************************************************************************************************
 * 45200 characters generated by Talend Open Studio for Data Integration on the
 * December 11, 2023 at 10:07:07 PM CET
 ************************************************************************************************/